...
class Confirm_1 extends StatelessWidget {
  const Confirm_1({super.key});
                ...
                (
                 ...
                 LottieBuilder.network(
                  ...
                  'https://lottie.host/6b2b4d50-1e55-45d3-b2db-c08d1ac6c6e4/lOoGDTyAl9.json',width: 200,height: 200,repeat: false,),
                   ...
                   Text("we've confirmed your request",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color:const Color.fromARGB(255, 7, 40, 89)),),
